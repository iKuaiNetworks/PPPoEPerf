 ...
 public:
  friend std::ostream &operator<<(std::ostream &o, TestStats &s) {
    ...
    if (test_config->ppp_stage_) {
      ss << "Send LCP config request successfully: "
         << s.lcp_config_req_send_ok_ << std::endl
         << "Send LCP config request failed: " << s.lcp_config_req_send_fail_
         << std::endl
         << "Resend LCP config request: " << s.lcp_config_req_resend_
         << std::endl
         << "Send LCP config ack successfully: " << s.lcp_config_ack_send_ok_
         << std::endl
         << "Send LCP config ack failed: " << s.lcp_config_ack_send_fail_
         << std::endl
         << "Send LCP echo reply successfully: " << s.lcp_echo_reply_send_ok_
         << std::endl
         << "Send LCP echo reply failed: " << s.lcp_echo_reply_send_fail_
         << std::endl << std::endl;
      ...
      ss << "Recv LCP echo request: " << s.lcp_echo_reqeust_rcv_ << std::endl
         ...
         << "Invalid LCP echo request: " << s.invalid_lcp_echo_request_
         << std::endl << std::endl;

      ss << "Recv PPP CHAP challenge: " << s.ppp_chap_challenge_rcv_++
         << std::endl
         << "Valid PPP CHAP challenge: " << s.valid_ppp_chap_challenge_++
         << std::endl
         << "Invalid PPP CHAP challenge: " << s.invalid_ppp_chap_challenge_++
         << std::endl << "PPP CHAP sucess: " << s.ppp_chap_success_ << std::endl
         << "PPP CHAP failed: " << s.ppp_chap_failed_ << std::endl;
  ...
  std::string get_stats() { return stats_; }
